...
import static io.flowset.control.facet.urlqueryparameters.CompletedBatchListQueryParamBinder.ID_PARAM;
import static io.flowset.control.view.util.FilterQueryParamUtils.getStringParam;

public class CompletedBatchIdHeaderFilter extends CompletedBatchHeaderFilter implements HasFilterUrlParamHeaderFilter {
    protected TypedTextField<String> idField;

    public CompletedBatchIdHeaderFilter(Grid<BatchData> dataGrid,
